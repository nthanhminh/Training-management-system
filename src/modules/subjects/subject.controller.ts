...
export class SubjectController {
    ...
    @Roles('TRAINEE')
    async createNewSubject(@Body() dto: CreateSubjectDto, @CurrentUserDecorator() user: User) : Promise<AppResponse<Subject>>{
        return {
    ...
    @Patch('info/:id')
    @UseGuards(SessionAuthGuard, RolesGuard)
    async updateSubjectInfo(@Body() dto: UpdateSubjectDto, @Param('id') id: string): Promise<AppResponse<UpdateResult>>{
        return {
    ...
    @Delete(':id')
    @UseGuards(SessionAuthGuard, RolesGuard)
    async deleteSubjectById(@Param('id') id: string, @CurrentUserDecorator() user: User): Promise<AppResponse<UpdateResult>>{
        return {
