...
export class AddUniqueConstraint1747980581828 implements MigrationInterface {
    name = 'AddUniqueConstraint1747980581828'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "UQ_3399e2710196ea4bf734751558f" UNIQUE ("title")`);
        await queryRunner.query(`ALTER TABLE "course_subject" ADD CONSTRAINT "UQ_6c46350ca1c7b93ac1cdf28adf4" UNIQUE ("courseId", "subjectId")`);
    }
